...
{
    public class SoChiTietPhaiThuController : Controller
    {
        // GET: SoChiTietPhaiThu
        ...
        public ActionResult SoChiTietPhaiThu_Fill()
        {
        ...
        public ActionResult SoChiTietPhaiThu()
        {
            List<MauInChungTu> dmDlist = LoadDmDt("");
            List<BKHoaDonGiaoHang> dmDlistTDV = LoadDmTDV();
            ...
            string Pname = "[usp_SoChiTietPhaiThuKH_SAP]";
