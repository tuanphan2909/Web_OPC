...
{
    public class SoChiTietPhaiTraController : Controller
    {
        // GET: SoChiTietPhaiTra
        ...
        public ActionResult SoChiTietPhaiTra_Fill()
        {
        ...
        public ActionResult Index()
        {
            ...
            string Pname = "[usp_SoChiTietCongNoPhaiTra_SAP]";
        ...
        public ActionResult SoChiTietPhaiTra()
        {
            List<MauInChungTu> dmDlist = LoadDmDt("");
            List<BKHoaDonGiaoHang> dmDlistTDV = LoadDmTDV();
            string ma_dvcs = Request.Cookies["MA_DVCS"].Value;
